                 ...
                 ?>
                        ...
                        <br>
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                              <select name="kate" id="select" class="form-control">
                                <option value="0">Kateqoriya</option>
                                <option value="1" <?php if ($row["kate_id"]==1) {
                                  echo "selected";
                                } ?>>Olke</option>
                                <option value="2" <?php if ($row["kate_id"]==2) {
                                  echo "selected";
                                } ?>>Siyaset</option>
                                <option value="3" <?php if ($row["kate_id"]==3) {
                                  echo "selected";
                                } ?>>Kriminal</option>
                                <option value="4" <?php if ($row["kate_id"]==4) {
                                  echo "selected";
                                } ?>>Sou-biznes</option>
                                <option value="5" <?php if ($row["kate_id"]==5) {
                                  echo "selected";
                                } ?>>Idman</option>
                                <option value="6" <?php if ($row["kate_id"]==6) {
                                  echo "selected";
                                } ?>>Maraqli</option>
