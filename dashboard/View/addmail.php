...
<div class="col-lg-10">
                    ...
                    <?php 
                    $sql=Controller::$conn->selectForEdit('mesaj',$param);
                     ...
                     ?>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                              ...
                              <input type="text" id="text-input" name="email" placeholder="email.." value="<?php echo $row["email"] ?>" class="form-control">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                              ...
                              <input type="text" id="text-input" name="subject" placeholder="mövzu.." value="<?php echo $row["movzu"]; ?>" class="form-control">
